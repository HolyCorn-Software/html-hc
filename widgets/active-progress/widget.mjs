...
The active-progress widget
Adapted from the multi-form-progress widget (2021)
...
export default class ActiveProgress extends Widget {

    /**
     * 
     * @param {object} param0 
     * @param {string[]} param0.enums
    ...
    constructor({ enums, length, value } = {}) {
        ...
        this.html = document.spawn({
            classes: ActiveProgress.classList,
            innerHTML: `
                <div class='container'>
    ...
    */
    ...
    static help() {
        return `
            ...
            The class name for this widget is hc-active-progress
...
export class Point extends Widget {
    ...
    constructor({ value }) {
        super();
        this.html = hc.spawn({
            class: 'hc-active-progress-point',
            innerHTML: `
                <div class='container'>
                    <div class='data'></div>
