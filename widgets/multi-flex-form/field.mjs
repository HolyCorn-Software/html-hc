...
export class MultiFlexFormField extends MultiFlexFormItem {
    ...
    /**
     * @param {InputTypes} type The new input type
     * @param {MultiFlexFormFieldData} params extra parameters that can be passed to control how the overall outcome will be
...
export class MultiFlexFormTextbox extends MultiFlexFormItem {
    ...
    /**
     * 
     * @param {InputTypes} type The input type
