...
export class PluralWidgetArray extends Object {
     ...
     */
    constructor({ parent, transforms, selector, property, immediate, onchange }) {
        super();
...
export default function pluralWidgetProperty({ selector = '*', example, childType, htmlElement, parentSelector, target, object, property, immediate = true, transforms = {}, onchange } = {}) {
    ...
    Reflect.defineProperty(target || object, property, {
        get: () => {
            ...
            return parent[widget_array_symbol][property] ||= new PluralWidgetArray({ parent, transforms, selector, property, immediate, onchange })
        },
        set: (value) => {
