...
export class __Widget extends EventTarget {
    ...
    constructor() {
        ...
        let moduleURL = hc.getCaller(0, [/html-hc\/lib/])
        if (moduleURL) {
        ...
        /** @deprecated, just use addEventListener @type {function(string, function(Event))} */
        this.on
    ...
    /**
     * @param {htmlhc.lib.widget.ExtendedHTML<this>} value
     */
    set html(value) {
    ...
    /**
     * @returns {htmlhc.lib.widget.ExtendedHTML<this>}
     */
    get html() {
        return this.#html
    }
     ...
     * @param {keyof WidgetType} param0.property
     * @param {string} param0.cwd The current working directory to resolve all images
     * @param {"inline"|"background"} param0.mode
     */
    defineImageProperty({ selector, property, cwd, mode }) {
        defineImageProperty.call(this, property, selector, cwd, mode)
    }
     ...
     * 
     * @template {keyof WidgetType} PropertyName
     * @template {htmlhc.lib.widget.ExtendedHTML<ItemWid>} ItemHTML
     * @template ItemWid
     * @param {htmlhc.lib.widget.WidgetPropertyArgs<WidgetType, PropertyName, "single",  ItemWid, ItemHTML>} param0 
     * 
     */
    widgetProperty({ selector, parentSelector, property, should_prepend, childType, immediate = true, onchange = () => 1, transforms = {}, object, target = this }) {
        ...
        Reflect.defineProperty(target || object, property, {
     ...
     * @template {htmlhc.lib.widget.ExtendedHTML<ItemWid>} ItemHTML
     * @template ItemWid
     * @param {htmlhc.lib.widget.WidgetPropertyArgs<WidgetType, PropertyName, "plural",  ItemWid, ItemHTML>} param0 
     * 
     * 
     * 
     */
    pluralWidgetProperty({ selector = '*', childType, parentSelector, property, transforms, immediate = true, target, object, onchange } = {}) {
    ...
    /**
     * 
     * @deprecated Just use dispatchEvent()
     */
    fire() {
