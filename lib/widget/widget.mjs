...
export class __Widget extends EventTarget {
     ...
     * @template {import('./types.js').ExtendedHTML<ItemWid>} ItemHTML
     * @template ItemWid
     ...
     * @template {import('./types.js').ExtendedHTML<ItemWid>} ItemHTML
     * @template ItemWid
     * @param {import('./types.js').WidgetPropertyArgs<WidgetType, PropertyName, "plural",  ItemWid, ItemHTML>} param0 
     * 
     * 
     * 
     */
    pluralWidgetProperty({ selector = '*', childType, parentSelector, property, transforms, immediate = true, onchange } = {}) {
