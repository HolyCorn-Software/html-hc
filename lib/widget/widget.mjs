...
export class __Widget extends EventTarget {
     ...
     * @param {string|symbol} param0.property The name of the property that will be bound to this object itself
     * @param {boolean} param0.should_prepend Whether we should add the widget as the first of the parent, or the last
     * @param {function(__Widget)} param0.onchange The function to be called when the value has changed
     * @param {('widget'|'html')} param0.childType If you don't want to specify a transform function, use this to specify if read values should be converted to HTMLElement or Widget
     * @param {{set:function(any):ExtendedHTML, get:function(ExtendedHTML): any}} param0.transforms Optional parameter which defines special functions (get and set) that allow the property to accept arbitary input in order to transform it to a widget, thereby allowing the api users more freedom, as well as transform a widget into a different type of output.
     * @param {object} param0.object Optionally specifying this will determine where the property will be stored. The property is normally stored on this
     * @param {boolean} param0.immediate If parameter is true, Only immediate children of the parent will be fetched
     */
     ...
     * @param {__Widget} param0.example 
     * @param {string} param0.parentSelector 
     * @param {string|symbol} param0.property 
     * @param {('html'|'widget')} param0.childType 
     * @param {boolean} param0.immediate Should we select immediate children only ?
     * @param {{
     * set: function(any): HTMLElement|__Widget,
     * get: function(ExtendedHTML) : any
     * }} param0.transforms 
     * 
     * 
     * 
     */
    pluralWidgetProperty({ selector = '*', example, childType, parentSelector, property, transforms, immediate = true } = {}) {
     ...
     * @template PromiseReturn
     * @param {Promise<PromiseReturn>} promise 
     * @returns {Promise<PromiseReturn>}
     */
