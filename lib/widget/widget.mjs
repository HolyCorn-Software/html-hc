...
export class __Widget extends EventTarget {
     ...
     * @template {ExtendedHTML} ItemHTML
     * @param {import('./types.js').WidgetPropertyArgs<WidgetType, PropertyName, "single", ItemHTML>} param0 
     * 
     */
     ...
     * @template {keyof WidgetType} PropertyName
     * @template ItemHTML
     * @param {import('./types.js').WidgetPropertyArgs<WidgetType, PropertyName, "plural", ItemHTML>} param0 
     * 
     * 
     * 
     */
