...
/**
 * NOTE: Remember to destroy the set of observers, when the widget (if applicable), is destroyed, or pass in an AbortSignal as ``signal``
 * 
 ...
 * @param {AbortSignal} param0.signal If this signal is destroyed, the watching would stop
 * @param {number} param0.propagationDelay This is how long we should wait, before invoking the callback
 * @returns {{destroy: ()=>void}} An object can be used to free up the resources allocated
 *  watching the changes
 */
export default function watchToCSS({ source, target, watch, apply, transform, signal, propagationDelay = 20 }) {
    ...
    const onDestroy = () => exitFxns.forEach(fxn => fxn())
