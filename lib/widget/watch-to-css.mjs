 ...
 * @param {string|(()=>void)} param0.apply The CSS property that will be written to. 
 * However, you can pass a function, and the function will be called instead
 * @param {(input:string|number|boolean)=>any} param0.transform An optional function,
...
export default function watchToCSS({ source, target, watch, apply, transform }) {
    ...
    if (watch.css) {
        ...
        observe(new ResizeObserver(doIt))
